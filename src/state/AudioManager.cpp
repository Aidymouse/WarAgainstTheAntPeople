...
// If there are multiple sounds that are done, only one will be removed each
// frame In addition, a stopped sound can get stuck behind a playing sound. But
// also all sounds are quite short so hopefully it doesn't matter
